...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------ | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| Home / Today    | \`/\`                                                                                                                                                                                            | \`HomeTodayContext\`<br>\`HomeDailyBrief\`<br>\`HomeWorkContextSummary\`<br>\`HomeWeekdayOverview\`<br>\`FirstWeekInsightBanner\`<br>\`AppNav\`<br>\`ScreenHeader\`                                                                                               | green  | green  | Configurable block order (#584); Figma still reference-era for removed sparkline/recent grids | Keep mobile as quick daily summary; block order user-configurable at \`/settings/home\`.                      |
...
| Insights        | \`/insights\`<br>\`/insights/disclaimer\`                                                                                                                                                        | \`InsightFeed\`<br>\`InsightCard\`<br>\`InsightMatrix\`<br>\`InsightQualityMeter\`<br>\`InsightConfidenceScale\`<br>\`TagGroupsSection\`<br>\`TagCooccurrenceHeatmap\`<br>\`SymptomAnalyticsSection\`<br>\`SymptomCooccurrenceDetailSheet\`<br>\`EntryHistorySheet\` | yellow | green  | Sprint 9 analytics component sets on Foundations; mobile drill-down via sheets | Mobile keeps feed + matrix first; web analytics expanded board uses component-set instances. Code Connect publish still blocked. |
| Settings        | \`/settings\`<br>\`/settings/home\`<br>\`/settings/tags\`<br>\`/settings/symptoms\`<br>\`/settings/app\`                                                                                                                                                              | \`ScreenHeader\`<br>\`Panel\`<br>\`Button\`<br>\`InlineAlert\`<br>\`ThemeToggle\`<br>\`HomeSectionsEditor\`                                                                                                                                                                                    | yellow | green  | Home layout editor shipped (#584); Figma frames for \`/settings/home\` still open | Add settings and tag-management backlog frames; keep mobile simple and web management-oriented.                                  |
...
| `HomeWorkContextSummary` | Shared             | low         | low      | Extracted from Daily Brief (#584); configurable on Home via `/settings/home`.                |
