...
> onward; prefer the latest **`v1.x`** release (e.g. **`v1.1.0`**).
...
strips the leading `v` for `versionName` (e.g. `v1.1.0` → `1.1.0`) and sets
`versionCode = major×1_000_000 + minor×1_000 + patch` (e.g. `1.1.0` → `1001000`).
