...
> onward; prefer the latest **`v1.x`** release (e.g. **`v1.3.0`**).
...
strips the leading `v` for `versionName` (e.g. `v1.3.0` → `1.3.0`) and sets
...
Tag example: `git tag v1.3.0 && git push origin v1.3.0`.
