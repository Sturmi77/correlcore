...
> onward; prefer the latest **`v1.0.x`** release (e.g. **`v1.0.6`**).
...
export ANDROID_VERSION_NAME=1.0.6
...
strips the leading `v` for `versionName` (e.g. `v1.0.6` → `1.0.6`) and sets
`versionCode = major×1_000_000 + minor×1_000 + patch` (e.g. `1.0.6` → `1000006`).
