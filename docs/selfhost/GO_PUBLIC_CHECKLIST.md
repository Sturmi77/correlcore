...
current release line is **1.x** (through `v1.7.1`, with Android sideload APKs).
...
Checklist for tagging a new **`v1.x`** release (e.g. `v1.5.0`) after the initial M10 go-public:
