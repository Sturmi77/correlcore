...
current release line is **1.x** (through `v1.2.0`, with Android sideload APKs).
...
Checklist for tagging a new **`v1.x`** release (e.g. `v1.2.0`) after the initial M10 go-public:
