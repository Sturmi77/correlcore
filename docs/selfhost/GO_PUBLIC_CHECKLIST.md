...
current release line is **1.x** (through `v1.1.7`, with Android sideload APKs).
...
Checklist for tagging a new **`v1.x`** release (e.g. `v1.1.7`) after the initial M10 go-public:
