...
| **M11**     | Android Play Store           | Capacitor **Sprint 1–3 landed** (shell, sideload, Bearer auth); widget / Play / ops remaining       | [`M11_SPRINT_PLAN.md`](M11_SPRINT_PLAN.md), ops [#429](https://github.com/Sturmi77/correlcore/issues/429) |
