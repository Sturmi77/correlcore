...
| **M11**     | Android Play Store           | Capacitor **Sprint 1–2 landed** (shell + signed sideload path); auth / widget / Play remaining      | `apps/android/`, [`ANDROID_SIDELOAD.md`](selfhost/ANDROID_SIDELOAD.md), [`M11_SPRINT_PLAN.md`](M11_SPRINT_PLAN.md) |
