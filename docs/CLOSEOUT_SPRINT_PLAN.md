...
| 7                  | M10 — Public Selfhost     | M10        | **Ready to close** — Sprint 6 complete; tag `v1.0.0` shipped. Hosted domain launch is **M10.2**, not this milestone — [`M10_2_PUBLIC_HOSTED_LAUNCH_PLAN.md`](M10_2_PUBLIC_HOSTED_LAUNCH_PLAN.md) |
