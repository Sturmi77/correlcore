...
| **M11**     | Android Play Store           | Capacitor **shell Sprint 1 landed**; Play listing / Glance / signed sideload remaining              | `apps/android/`, [ADR-0002](adr/0002-capacitor-statt-twa.md), [`M11_NOTES.md`](M11_NOTES.md), [`M11_SPRINT_PLAN.md`](M11_SPRINT_PLAN.md) |
