...
| **M11**     | Android Play Store           | Capacitor **scaffold landed** (#27); Play listing / Glance widget remaining                         | `apps/android/`, [ADR-0002](adr/0002-capacitor-statt-twa.md), [`M11_NOTES.md`](M11_NOTES.md), [`M11_SPRINT_PLAN.md`](M11_SPRINT_PLAN.md) |
