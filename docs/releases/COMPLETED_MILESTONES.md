...
| **M10**   | ✅ 2026-07-11 | Public selfhost **v1.0**. Tag `v1.0.0`; patch line `v1.0.1`–`v1.0.5` (Android sideload hardening). [`M10_SPRINT_STATUS.md`](../M10_SPRINT_STATUS.md), [`CHANGELOG.md`](../../CHANGELOG.md#100--public-selfhost-release--2026-07-11)             |
