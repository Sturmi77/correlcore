...
**Archived:** 2026-07-19  
**Baseline:** Public selfhost release line **`1.0.x`** (first tag `v1.0.0` on 2026-07-11; latest patch `v1.0.8`; in-repo manifests/i18n/export aligned to `1.0.8`).
...
| **M10**   | ✅ 2026-07-11 | Public selfhost **v1.0**. Tag `v1.0.0`; patch line `v1.0.1`–`v1.0.8` (Android sideload hardening). [`M10_SPRINT_STATUS.md`](../M10_SPRINT_STATUS.md), [`CHANGELOG.md`](../../CHANGELOG.md#100--public-selfhost-release--2026-07-11)             |
