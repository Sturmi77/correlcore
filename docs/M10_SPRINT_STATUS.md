...
- [x] Tag `v1.0.0-rc.1` pushed — tag exists (patch line through `v1.0.5` also tagged).
...
- [x] Tag **`v1.0.0`** pushed — tag exists (patch line through `v1.0.5`).
- [x] GitHub milestone #7 (M10 Public Selfhost) closed — tags `v1.0.0`–`v1.0.5` published.

## Next milestone

**M11** — Android Play Store (Capacitor). Engineering sprints **1–5 shipped** (shell, sideload,
Bearer auth, Glance widget, FCM registration code); **Play Console exit open** ([#429](https://github.com/Sturmi77/correlcore/issues/429)).
See [`DESIGN_DOCUMENT.md`](DESIGN_DOCUMENT.md) § M11 and [`M11_SPRINT_PLAN.md`](M11_SPRINT_PLAN.md).
