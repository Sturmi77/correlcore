...
- [`COMPARE_AXIS_ZOOM_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_PLAN.md) + [`COMPARE_AXIS_ZOOM_IMPLEMENTATION_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_IMPLEMENTATION_PLAN.md) + [`COMPARE_AXIS_ZOOM_SPRINT_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_SPRINT_PLAN.md) — Trends Compare shared-axis bird’s-eye zoom (proposed 2026-07-20; [#472](https://github.com/Sturmi77/correlcore/issues/472), plan PR [#473](https://github.com/Sturmi77/correlcore/pull/473), docs [#477](https://github.com/Sturmi77/correlcore/pull/477))
