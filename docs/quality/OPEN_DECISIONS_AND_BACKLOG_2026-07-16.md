...
- [`COMPARE_AXIS_ZOOM_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_PLAN.md) + [`COMPARE_AXIS_ZOOM_IMPLEMENTATION_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_IMPLEMENTATION_PLAN.md) + [`COMPARE_AXIS_ZOOM_SPRINT_PLAN.md`](../frontend/COMPARE_AXIS_ZOOM_SPRINT_PLAN.md) — Trends Compare shared-axis bird’s-eye zoom (**CAZ-0 frozen** 2026-07-20: default 7d, hide range chips, stages 1/3/7/14/28, tap one-stage zoom-in; next **CAZ-1**; [#472](https://github.com/Sturmi77/correlcore/issues/472), docs [#473](https://github.com/Sturmi77/correlcore/pull/473)/[#477](https://github.com/Sturmi77/correlcore/pull/477))
