# Feature & Ops Issue Drafts (2026-07-23)

Index der GitHub Issues aus Findings (Home, Insights, Habits, Ops). Drafts bleiben als kanonische Spec im Repo.

| #   | Issue                                                     | Draft                                                                                      | Title                               |
| --- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ----------------------------------- |
| 1   | [#487](https://github.com/Sturmi77/correlcore/issues/487) | [FEATURE_HOME_WEEKDAY_TOP_SIGNAL.md](FEATURE_HOME_WEEKDAY_TOP_SIGNAL.md)                   | Home weekday top signal             |
| 2   | [#488](https://github.com/Sturmi77/correlcore/issues/488) | [FEATURE_LAG_CORRELATION_VISUALIZATION.md](FEATURE_LAG_CORRELATION_VISUALIZATION.md)       | Lag correlation visualization       |
