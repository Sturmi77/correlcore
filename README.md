...
- [ ] **M11** — Android Play Store (Capacitor) — shell Sprint 1 done (`apps/android/android`, debug APK CI); Play listing / widget / signed sideload remaining — [`docs/M11_SPRINT_PLAN.md`](docs/M11_SPRINT_PLAN.md)
