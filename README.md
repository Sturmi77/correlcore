...
<p align="center">
  ...
  <a href="https://github.com/Sturmi77/correlcore/releases"><img src="https://img.shields.io/badge/latest-v1.0.8-informational" alt="Latest tag" /></a>
</p>
...
**Public selfhost line:** tag **`v1.0.0`** (2026-07-11, M10) through **`v1.0.8`** (Compare axis zoom, landing redesign, review fixes). Docs: [sturmi77.github.io/correlcore](https://sturmi77.github.io/correlcore/). Release notes: [`CHANGELOG.md`](CHANGELOG.md).
...
# Prefer IMAGE_TAG=v1.0.8 (or latest v1.0.x) for published GHCR images
...
> **Note:** Public selfhost **`1.0.x`** is the supported release line. Treat M8 / M11 Play exit / M13 full scope as active development on top of that baseline. See [`SECURITY.md`](SECURITY.md) and [`CHANGELOG.md`](CHANGELOG.md).
