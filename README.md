...
- [ ] **M9** — Beta hardening: monitoring, GlitchTip, external testers, documentation (Sprints 1–5 complete). See [`docs/M9_SPRINT_PLAN.md`](docs/M9_SPRINT_PLAN.md) and [`docs/M9_SPRINT_STATUS.md`](docs/M9_SPRINT_STATUS.md).
...
| **M9**    | **In progress** (Sprint 5) | Beta hardening: program docs, feedback triage, analytics reviews done. Sprint 6 closeout pending. See [`docs/M9_SPRINT_PLAN.md`](docs/M9_SPRINT_PLAN.md) and [`docs/M9_SPRINT_STATUS.md`](docs/M9_SPRINT_STATUS.md).                                                              |
